...
while 1:
    ...
    for (mx,my,mw,mh) in mobile:
        cv2.rectangle(roi_color,(mx,my),(mx+mw,my+mh),(0,255,0),2)
        font=cv2.FONT_HERSHEY_SIMPLEX
        cv2.putText(img,word3,(mx-mw,my+mh),font,1,(255,255,0),2,cv2.LINE_AA)
    ...
    for (px,py,pw,ph) in plate:
        cv2.rectangle(roi_color,(px,py),(px+pw,py+ph),(0,255,0),2)
        font=cv2.FONT_HERSHEY_SIMPLEX
        cv2.putText(img,word5,(px-pw,py+ph),font,1,(255,255,0),2,cv2.LINE_AA)
    ...
    vehicle = vehicle_cascade.detectMultiScale(gray,1.3, 5)
    for (vx,vy,vw,vh) in vehicle:
        cv2.rectangle(roi_color,(vx,vy),(vx+vw,vy+vh),(0,255,0),2)
        font=cv2.FONT_HERSHEY_SIMPLEX
        cv2.putText(img,word9,(vx-vw,vy+vh),font,1,(255,255,0),2,cv2.LINE_AA)
